...
from ceaadmin.services.catalog import CatalogService
from ceaadmin.services.admin import AdminService
from ceaadmin.services.generations import GenerationService
from ceaadmin.services.payments import PaymentService
from ceaadmin.services.referrals import ReferralService
from ceaadmin.services.subscriptions import SubscriptionService
from ceaadmin.services.text_chats import TextChatService
from ceaadmin.services.users import UserService
from ceaadmin.services.vpn import VpnService
...
def build_services(
    ...
    return AppServices(
        ...
        generations=GenerationService(db, None),
