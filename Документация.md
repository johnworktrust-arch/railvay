...
```text
Старт   — 449 руб. / 60 коинов / 30 дней
Базовый — 890 руб. / 150 коинов / 30 дней
Про     — 1990 руб. / 360 коинов / 30 дней
```
...
| Тариф | Цена | Период | Коинов | Эффективная цена 1 коина |
| --- | ---: | ---: | ---: | ---: |
| Старт | 449 руб. | 30 дней | 60 | ~7.48 руб. |
| Базовый | 890 руб. | 30 дней | 150 | ~5.93 руб. |
| Про | 1990 руб. | 30 дней | 360 | ~5.53 руб. |
...
```text
60 сообщений DeepSeek = 60 коинов
или 20 сообщений ChatGPT = 60 коинов
```

`Базовый` — для регулярного пользователя, который использует текстовые нейросети.

Пример, который укладывается в 150 коинов:

```text
150 сообщений DeepSeek = 150 коинов
или 50 сообщений ChatGPT = 150 коинов
```

`Про` — для активного пользователя, который много работает с текстовыми нейросетями.

Пример, который укладывается в 360 коинов:

```text
360 сообщений DeepSeek = 360 коинов
или 120 сообщений ChatGPT = 360 коинов
```
