...
class MigrationAndUITest(unittest.TestCase):
    ...
    def test_plan_screen_uses_new_prices_and_coins_are_called_koiny(self) -> None:
        ...
        self.assertIn("⭐️ <b>Старт</b>", start_details)
        self.assertIn("299 ₽ или 319 ⭐", start_details)
        self.assertIn("25 коинов · 30 дней", start_details)
        self.assertIn("Для знакомства с Cea AI.", start_details)
        self.assertNotIn("➕", start_details)
        self.assertNotIn("До 8", start_details)
        self.assertIn("💳 Выберите способ оплаты:", start_details)
        self.assertIn("🔥 <b>Базовый</b>", basic_details)
        self.assertIn("699 ₽ или 749 ⭐", basic_details)
        self.assertIn("60 коинов · 30 дней", basic_details)
        self.assertIn("Для регулярного использования.", basic_details)
        self.assertNotIn("➕", basic_details)
        self.assertIn("⚡️ <b>Про</b>", pro_details)
        self.assertIn("1490 ₽ или 1599 ⭐", pro_details)
