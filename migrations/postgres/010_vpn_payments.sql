ALTER TABLE vpn_subscriptions
    ADD COLUMN IF NOT EXISTS billing_kind TEXT NOT NULL DEFAULT 'trial'
...
CREATE TABLE IF NOT EXISTS vpn_payments (
    ...
    vpn_plan_id BIGINT NOT NULL REFERENCES vpn_plans(id),
    vpn_subscription_id BIGINT REFERENCES vpn_subscriptions(id),
