...
from ceavpn.json_utils import loads_dict
from ceavpn.providers.base import AIProvider, ImageInput, ProviderError
from ceavpn.repositories.generations import GenerationRepository
from ceavpn.repositories.model_prices import ModelPriceRepository
from ceavpn.repositories.subscriptions import SubscriptionRepository
from ceavpn.runtime_diagnostics import record_error
from ceavpn.services.coins import CoinService
from ceavpn.services.exceptions import (
    GenerationProviderFailedError,
    InsufficientCoinsError,
    NoActiveSubscriptionError,
    NotFoundError,
)
from ceavpn.services.subscription_recovery import (
...
def _model_with_tts_options(
    model: Dict[str, Any], *, voice: str | None
) -> Dict[str, Any]:
